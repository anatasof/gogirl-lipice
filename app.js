    ...
    $('.logo').fadeOut(250, function(){
      ...
      for(i = 0; i < shu.length; i++){
        ...
        $('<div class="card" style="width:'+cardSize+'%;height:'+cardSize+'%;">'+
          '<div class="flipper"><div class="f"></div><div class="b" style="width: 100%; height: 100%; display: flex; align-items: center;" data-f="&#xf0'+code+';" data-code="'+code+'"><img style="display: block; max-width: 85%; max-height: 100%; margin: 0 auto;" src="./assets/ICON-GAMES-'+code+'.png" /></div></div>'+
          '</div>').appendTo('#g');
      }
